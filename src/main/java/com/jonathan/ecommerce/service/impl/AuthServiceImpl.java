...
public class AuthServiceImpl implements AuthService {
  ...
  public AuthResponse login(AuthRequest request) {
    ...
    return new AuthResponse(
        accessToken, refreshToken, user.getEmail(), user.getName(), user.getRole().name());
  }
  ...
  public AuthResponse refreshToken(String refreshToken) {
    ...
    refreshToken1.setReplacedByToken(HashUtil.hashToken(newRefreshToken));
    ...
    return new AuthResponse(
        newAccessToken, newRefreshToken, user.getEmail(), user.getName(), user.getRole().name());
  }
