...
class PasswordResetServiceImplTest {
  ...
  @Test
  void validateToken_whenTokenIsNull_shouldThrowException() {
    assertThrows(
        IllegalArgumentException.class, () -> passwordResetServiceImpl.validateToken(null));
  }

  @Test
  void validateToken_whenTokenNotFound_shouldThrowResourceNotFoundException() {
  ...
  @Test
  void validateToken_whenTokenExpired() {
  ...
  @Test
  void validateToken_whenTokenValid() {
    PasswordResetToken token = new PasswordResetToken();
